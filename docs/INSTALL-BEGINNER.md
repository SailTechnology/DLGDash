...
按[完整机型表](RADIOS.md)选择 **DLGDash-Color-v1.1.1.zip**（彩屏）或 **DLGDash-Monochrome-v1.1.1.zip**（黑白屏）。也可直接阅读 [彩屏教程](INSTALL-COLOR.md)或[黑白屏教程](INSTALL-MONO.md)。本版扩展常见机型，保留绘图和黑白屏内存、保存修复，仍需真机地面验证。下图使用模拟数据。
...
3. 打开 [v1.1.1 下载页](https://github.com/SailTechnology/DLGDash/releases/tag/v1.1.1)，展开 **Assets**。彩屏选 **DLGDash-Color-v1.1.1.zip**，黑白屏选 **DLGDash-Monochrome-v1.1.1.zip**。不要选 Source code，也不要仅下载 SHA256SUMS.txt。
