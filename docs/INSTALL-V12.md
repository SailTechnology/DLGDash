...
适用于 HelloRadio V12 / V12 CNC MAX、固件标识 v12、EdgeTX、320×240 横向彩屏。当前为实验适配，尚未通过 V12 实机验收。请在 [v1.1.1 发布页](https://github.com/SailTechnology/DLGDash/releases/tag/v1.1.1)下载 `DLGDash-Color-v1.1.1.zip`，不要误用黑白屏包。
