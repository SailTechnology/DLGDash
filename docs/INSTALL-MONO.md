...
适用 X9D / X9E、GX12、Zorro、HelloRadio V14、T14、Boxer、Pocket、TX12、T12 / T20 / T-Pro / T-Lite、X7 / X9 Lite / X-Lite 等表内 EdgeTX 机型，完整型号和状态见 [机型表](RADIOS.md)。新增机型仍需地面验证；OpenTX、Ethos 和其他未知机型暂不保证兼容。
...
1. 完整备份后，把内容盘的 `WIDGETS/DLGDash` 改名为未使用的名字，如 `DLGDash-before-beta5`，不要覆盖已有备份。
