...
foreach ($board in $radios.board) {
    ...
    if ($installed.Version -ne '1.1.1-test.1' -or $installed.VerifiedUnchangedModelRadioFiles -ne 2 -or $installed.VerifiedUnchangedWidgetProfiles -ne 1) { throw 'Installation verification mismatch' }
