...
foreach ($board in @('pa01', 'v16', 'x9d', 'x9d+', 'x9d+2019', 'gx12', 'zorro')) {
    ...
    if ($installed.Version -ne '1.0.1-beta.3' -or $installed.VerifiedUnchangedModelRadioFiles -ne 2 -or $installed.VerifiedUnchangedWidgetProfiles -ne 1) { throw 'Installation verification mismatch' }
